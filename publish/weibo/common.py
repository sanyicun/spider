...
#设置参数
APP_KEY = '3524940256'
APP_SECRET = '091244097b2f9db814211ce58077dc9e'
CALLBACK_URL = 'http://api.sanyicun.com/callback.php'
#CALLBACK_URL = 'https://api.weibo.com/oauth2/default.html'
AUTH_URL = 'https://api.weibo.com/oauth2/authorize'
weibo_username = '1523632197@qq.com'
#weibo_username = 'justastriver@gmail.com'
weibo_pwd = '520heyi'
...
def get_prelogin_status(username):
    prelogin_url = 'http://login.sina.com.cn/sso/prelogin.php?entry=openapi&callback=sinaSSOController.preloginCallBack&su=' + get_user(username) + \
...
def setLoginPara():
    #username = '1523632197@qq.com'
    #pwd = '520heyi'
    cookie_file = 'weibo_login_cookies.dat'
    code = get_code(weibo_username, weibo_pwd, cookie_file)
    SetPara(code)
...
def send_text_pic(text=None,filepath=None):
		if filepath==None:
...
if __name__ == "__main__":
    ...
    filepath="../1.png"
    send_text_pic(utext, filepath)
    #client.statuses.upload.post(status=utext, pic = )
